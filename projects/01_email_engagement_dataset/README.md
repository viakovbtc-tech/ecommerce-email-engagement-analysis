...
Email-канал є одним із ключових інструментів утримання користувачів у e-commerce.

Цей датасет дозволяє:
- Визначити ключові країни за обсягом підписників та активністю
- Оцінити вплив верифікації акаунта на engagement
- Порівняти поведінку підписаних та відписаних користувачів
- Аналізувати вплив інтервалу відправлення (send_interval) на відкриття та переходи

Набір може використовуватись для:
- CRM-оптимізації
- Сегментації користувачів
- Виявлення перспективних ринків
